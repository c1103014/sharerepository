========================================================================
    Win32 アプリケーション: ServerOperation プロジェクトの概要
========================================================================

この ServerOperation アプリケーションは、AppWizard により作成されました。

このファイルには、ServerOperation 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


ServerOperation.vcxproj
...
ServerOperation.vcxproj.filters
...
ServerOperation.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル ServerOperation.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル ServerOperation.rc 
    にインクルードされます。
